package com.mangelovski.feedme.demo.security;

import com.mangelovski.feedme.demo.domain.PersistentToken;
import com.mangelovski.feedme.demo.domain.User;
import com.mangelovski.feedme.demo.repository.PersistentTokenRepository;
import com.mangelovski.feedme.demo.repository.UserRepository;
...
public class CustomPersistentRememberMeServices extends
    ...
    public CustomPersistentRememberMeServices(Environment env, org.springframework.security.core.userdetails.UserDetailsService userDetailsService) {
        ...
        super(env.getProperty("feedme.security.rememberme.key"), userDetailsService);
